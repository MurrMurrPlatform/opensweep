...
_CONSTRAINTS = [
    ...
    "CREATE CONSTRAINT investigation_uid IF NOT EXISTS FOR (n:Investigation) REQUIRE n.uid IS UNIQUE",
...
_INDEXES = [
    ...
    # Investigations
    "CREATE INDEX investigation_repo IF NOT EXISTS FOR (n:Investigation) ON (n.repository_uid)",
    "CREATE INDEX investigation_job_type IF NOT EXISTS FOR (n:Investigation) ON (n.job_type)",
