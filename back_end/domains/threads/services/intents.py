...
def build_thread_session_intent(ticket, thread_uid: str) -> str:
    ...
    return (
        ...
        f"{ac}\n"
        "\n"
        "Throughout this conversation, maintain your native todo list "
        "(TodoWrite): create it when you start, keep statuses current as you "
        "explore, question, and plan. The platform mirrors it to the thread "
        "as live progress the user watches — an empty todo list reads as no "
        "progress.\n"
        "\n"
        "Task:\n"
