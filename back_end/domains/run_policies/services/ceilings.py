...
max_tool_turns / max_files_touched) apply to every executor. There are no
per-run cost ceilings — executors still report tokens/dollars usage (the
UsageSnapshot fields stay), but money safety lives in the policy's daily
aggregates, not here.
"""
